...
*** {5} AkiNetGenTest_plot.py ***
1. Plot Fig. 6 (data not included)


Note: 
(1) the map in Fig. 1 is taken from ADAMA2 paper. The small plot showing the station locations and station connections can be easily plotted from 'Boxconn.csv'
...
(4) "BoxRegionTest.ipynb" also includes the split violin plot for the data in Fig. 5, although we didn't include this violin plot in the paper.  
...
{6} "Genconn.csv": the station pairs we used in our generalization test (Fig. 6).
{7} "GenTestAkiNet.pkl": the AKiNet inversion results for the station pairs in "Genconn.csv". 
